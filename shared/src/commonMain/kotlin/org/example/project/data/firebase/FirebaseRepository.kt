...
interface FirebaseRepository {
    ...
    suspend fun updateReport(reportId: String, description: String? = null, name: String? = null, phone: String? = null, imageUrl: String? = null, isLost: Boolean? = null, location: String? = null)
